				  ...
				  <div class="panel-body">	 
					...
					<table class="table table-bordered table-striped table-hover">
						...
						<tr>
							...
							<td colspan="3"><input type="text" class="form-control" name="body" value="chenyunxiaomi" readonly="readonly">
							<!-- 设置 程序回传到的链接地址 -->
							<input type="hidden" class="form-control" name="url" value="http://localhost:8080/chenyunxiaomi/wxcallback">
							</td>
						</tr>
