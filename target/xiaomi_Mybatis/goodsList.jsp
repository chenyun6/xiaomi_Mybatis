	    ...
	    <div class="row ${pageBean.total<=0?"div1":"" }">
			...
			<nav aria-label="..." class="text-center">
			  <ul class="pagination">
			  	...
			  	<c:if test="${pageBean.pageNum>1 }">
			  	 	<li><a href="${pageContext.request.contextPath }/goodsservlet?method=getGoodsListByTypeId&pageNum=${pageBean.prePage}&pageSize=${pageBean.pageSize}&typeId=${typeId}" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
			  	</c:if>
			    ...
			    <c:if test="${pageBean.pageNum==pageBean.pages }">
			     <li class="disabled"><span aria-hidden="true">»</span></li>
			      ...
			      <c:if test="${pageBean.pageNum<pageBean.pages }">
			     <li><a href="${pageContext.request.contextPath }/goodsservlet?method=getGoodsListByTypeId&pageNum=${pageBean.nextPage}&pageSize=${pageBean.pageSize}&typeId=${typeId}" aria-label="Next"><span aria-hidden="true">»</span></a></li>
			    </c:if>
