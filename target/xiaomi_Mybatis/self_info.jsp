...
<div id="dingdanxiangqing_body">
    <div id="dingdanxiangqing_body_big">
        <div id="big_left">
               ...
               <a id="big_left_a" href="${pageContext.request.contextPath}/userservlet?method=getOrderList">我的订单</a><br/>
							  ...
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
									...
									<form action="userservlet?method=updateAddress" method="post" class="form-horizontal">
											<div class="motal-body" style="margin-left: 100px">
										...
										<div class="motal-footer text-center" style="margin: 50px">
